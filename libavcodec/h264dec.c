...
#include "rectangle.h"
#include "thread.h"
#include "cyl2analyzer.h" // changyanlong
...
//                CYLCodecAnalyzerLinkListNode *node = (CYLCodecAnalyzerLinkListNode *)malloc(sizeof(CYLCodecAnalyzerLinkListNode));
//                int size_qp = h->mb_num * sizeof(signed char);
//                printf("qp_size ========> %d, mb_num=======>%d\n", size_qp, h->mb_num);
//                avctx->my_qp = (signed char *) malloc(size_qp);
//                memcpy(avctx->my_qp, h->cur_pic_ptr->qscale_table, size_qp);
...
//                    printf("%d ",h->slice_ctx[0].mb_xy);
                    ...
                    CYLCodecAnalyzerLinkListNode *analyzer_link_node = (CYLCodecAnalyzerLinkListNode *)malloc(sizeof(CYLCodecAnalyzerLinkListNode));

                    // changyanlong 这里分配的最终要先外部释放
                    ptr->next               = analyzer_link_node;
                    ptr                     = ptr->next;
                    ptr->mb_index           = ind;
                    ptr->qp_item            = qp_item;
                    ptr->mb_item_type       = mb_type_item;
                    ptr->next               = NULL;
                    analyzer_link_node      = NULL;

                    // 0x%05x- mb_type_item
//                    printf("%hhu-", qp_item);

                    // @changyanlong check mb_type define
                    if (IS_INTRA4x4(mb_type_item)) {
//                        printf("IS_INTRA4x4 ");
                        ptr->mb_desc = CYL_ANALYZE_MB_TYPE_IS_INTRA4x4;

                    } else if (IS_INTRA16x16(mb_type_item)) {
//                        printf("IS_INTRA16x16 ");
                        ptr->mb_desc = CYL_ANALYZE_MB_TYPE_IS_INTRA16x16;

                    } else if (IS_PCM(mb_type_item)) {
//                        printf("IS_PCM ");
                        ptr->mb_desc = CYL_ANALYZE_MB_TYPE_IS_PCM;

                    } else if (IS_INTRA(mb_type_item)) {
//                        printf("IS_INTRA ");
                        ptr->mb_desc = CYL_ANALYZE_MB_TYPE_IS_INTRA;

                    } else if (IS_INTER(mb_type_item)) {
//                        printf("IS_INTER ");
                        ptr->mb_desc = CYL_ANALYZE_MB_TYPE_IS_INTER;

                    } else if (IS_SKIP(mb_type_item)) {
//                        printf("IS_SKIP ");
                        ptr->mb_desc = CYL_ANALYZE_MB_TYPE_IS_SKIP;

                    } else if (IS_INTRA_PCM(mb_type_item)) {
//                        printf("IS_INTRA_PCM ");
                        ptr->mb_desc = CYL_ANALYZE_MB_TYPE_IS_INTRA_PCM;

                    } else if (IS_INTERLACED(mb_type_item)) {
//                        printf("IS_INTERLACED ");
                        ptr->mb_desc = CYL_ANALYZE_MB_TYPE_IS_INTERLACED;

                    } else if (IS_DIRECT(mb_type_item)) {
//                        printf("IS_DIRECT ");
                        ptr->mb_desc = CYL_ANALYZE_MB_TYPE_IS_DIRECT;

                    } else if (IS_GMC(mb_type_item)) {
//                        printf("IS_GMC ");
                        ptr->mb_desc = CYL_ANALYZE_MB_TYPE_IS_GMC;

                    } else if (IS_16X16(mb_type_item)) {
//                        printf("IS_16X16 ");
                        ptr->mb_desc = CYL_ANALYZE_MB_TYPE_IS_16X16;

                    } else if (IS_16X8(mb_type_item)) {
//                        printf("IS_16X8 ");
                        ptr->mb_desc = CYL_ANALYZE_MB_TYPE_IS_16X8;

                    } else if (IS_8X16(mb_type_item)) {
//                        printf("IS_8X16 ");
                        ptr->mb_desc = CYL_ANALYZE_MB_TYPE_IS_8X16;

                    } else if (IS_8X8(mb_type_item)) {
//                        printf("IS_8X8 ");
                        ptr->mb_desc = CYL_ANALYZE_MB_TYPE_IS_8X8;

                    } else if (IS_SUB_8X8(mb_type_item)) {
//                        printf("IS_SUB_8X8 ");
                        ptr->mb_desc = CYL_ANALYZE_MB_TYPE_IS_SUB_8X8;

                    } else if (IS_SUB_8X4(mb_type_item)) {
//                        printf("IS_SUB_8X4 ");
                        ptr->mb_desc = CYL_ANALYZE_MB_TYPE_IS_SUB_8X4;

                    } else if (IS_SUB_4X8(mb_type_item)) {
//                        printf("IS_SUB_4X8 ");
                        ptr->mb_desc = CYL_ANALYZE_MB_TYPE_IS_SUB_4X8;

                    } else if (IS_SUB_4X4(mb_type_item)) {
//                        printf("IS_SUB_4X4 ");
                        ptr->mb_desc = CYL_ANALYZE_MB_TYPE_IS_SUB_4X4;

                    } else if (IS_ACPRED(mb_type_item)) {
//                        printf("IS_ACPRED ");
                        ptr->mb_desc = CYL_ANALYZE_MB_TYPE_IS_ACPRED;

                    } else if (IS_QUANT(mb_type_item)) {
//                        printf("IS_QUANT ");
                        ptr->mb_desc = CYL_ANALYZE_MB_TYPE_IS_QUANT;

                    } else {
//                        printf("UnKnow ");
                        ptr->mb_desc = CYL_ANALYZE_MB_TYPE_UnKnow;
                    }
                    // end check
...
//                printf("===========>>> START <<<==============");
//                CYLCodecAnalyzerLinkListNode *ptr1 = avctx->cyl_analyzer_head;
//
//                while (ptr1 != NULL) {
//                    if (ptr1->mb_index >= 0) {
//                        printf("%d-%hhu-%s | ",ptr1->mb_index,ptr1->qp_item,ptr1->mb_desc);
//                    } else {
//                        printf("[%d] \n",ptr1->mb_index);
//                    }
//
