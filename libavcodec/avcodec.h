...
//    uint32_t* mb_type;
     ...
     * @return
     */
    int (*cyl_test)(int num);

    /**
     * changyanlong
     * 是否打开调试开关
     * @param avctx
     * @param is_open <= 0 否 1 是
     * @return
     */
    int (*cyl_analyzer_state_switch)(struct AVCodecContext *avctx, int is_open);
} AVCodecContext;
 ...
 * @return
 */
//attribute_deprecated // 暂时不需要字节对齐
//int cyl_analyzer_release_link_list_node(CYLCodecAnalyzerLinkListNode *cyl_analyzer_head);
